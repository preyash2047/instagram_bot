...
browser.get('https://www.yelp.com/biz/asian-american-food-company-san-francisco-3')
time.sleep(5) #???

browser.find_element_by_xpath('//*[@id="wrap"]/div[3]/yelp-react-root/div/div[2]/div[1]/div[1]/div/div/div[1]/h1').text
